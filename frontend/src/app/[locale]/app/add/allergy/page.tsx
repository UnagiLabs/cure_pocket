...
export default function AddAllergyPage() {
  ...
  const handleInputChange = (field: string, value: string | AllergySeverity) => {
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => handleInputChange('severity', e.target.value as AllergySeverity)}
            className="w-full rounded-lg border p-3"
            style={{
              backgroundColor: theme.colors.surface,
              borderColor: theme.colors.textSecondary + '40',
          ...
          >
            ...
            <option value="life-threatening">{t('allergies.severities.life-threatening')}</option>
          </select>
        </div>
