...
export default function AddDataPage() {
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <p className="mb-6 text-center text-sm md:text-base" style={{ color: theme.colors.textSecondary }}>
        {t('add.subtitle')}
      </p>
      ...
      >
        <div className="flex items-center md:flex-col md:text-center">
          ...
          >
                  <Icon className="h-8 w-8 md:h-12 md:w-12" style={{ color: dataType.color }} />
          </div>
                <div className="flex-1 text-left md:text-center">
            <div className="mb-1 font-bold md:text-lg" style={{ color: theme.colors.text }}>
                    {dataType.title}
            </div>
            <div className="text-sm md:text-base" style={{ color: theme.colors.textSecondary }}>
